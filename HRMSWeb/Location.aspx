        ...
        <div class="row">
            ...
            <div class="card p-3 border-0 ">
                <div class="row mb-2">
                    ...
                    <div class="col-lg-4">
                        <asp:TextBox ID="txtMailAlias" CssClass="form-control textboxCss" runat="server" placeholder="admin@example.com" TextMode="Email"></asp:TextBox>
                    </div>
                </div>
        ...
        <asp:GridView ID="GridView1" runat="server" CssClass="p-5 table table-bordered table-striped" DataKeyNames="locationId"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Mail Alias">
                    <EditItemTemplate>
                        <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("Mail_Alias") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="Label2" runat="server" Text='<%# Bind("Mail_Alias") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="State/Province">
                    <EditItemTemplate>
                        <asp:TextBox ID="TextBox4" runat="server" Text='<%# Bind("State_Province") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="Label4" runat="server" Text='<%# Bind("State_Province") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
